...
export function LeaderNameField({
  ...
  return (
    <div className="mu-leader-pick">
      <div className={`mu-leader-pick__art${id ? ' has-id' : ''}`} aria-hidden={!id}>
        {id ? (
          <CardPreviewFromId cardId={id.toUpperCase()} size="md" />
        ) : (
          <div className="mu-leader-pick__placeholder" />
        )}
      </div>

      <div className="mu-leader-pick__fields">
        ...
        <div className="mu-leader-pick__meta">
